...
const inventory = {
	...
	handlers: {
		...
		zipCode: function () {
			...
			if (zipCode.match(/^[0-9]{5}$/)) {
				let url = "/api/inventory/getzipcode?zipcode=" + zipCode;
				inventory.doGet(url)
		...
		submit: function () {
			...
			if (errorCount.length == 0) {
				...
				let url = "/api/inventory/getinventoryresults?make=" + make + "&model=" + model + "&zipCode=" + zipCode + "&isNew=" + conditionNew + "&isUsed=" + conditionUsed + "&bodyStyle=" + bodyStyle + "&inventoryType=" + inventoryType + "&mtCertified=" + mtCertified + "&sortOption=" + sortOption + "&referralDataEncoded=" + referralDataEncoded;
	...
	updateVehicleCount: function () {
		...
		let url = "/api/inventory/getvehiclecount?make=" + make + "&model=" + model + "&zipCode=" + zip + "&sellerDtxID=" + sellerDtxID + "&bodyStyle=" + bodyStyle + "&isNew=" + conditionNew + "&isUsed=" + conditionUsed + "&mtCertified=" + mtCertified + "&inventoryType=" + inventoryType;
		...
		let observer = new IntersectionObserver((entries, options) => {
			entries.forEach(entry => {
				if (entry.isIntersecting) {
					...
					let url = "/api/inventory/getinventoryresults?make=" + make + "&model=" + model + "&zipCode=" + zipCode + "&isNew=" + conditionNew + "&isUsed=" + conditionUsed + "&bodyStyle=" + bodyStyle + "&inventoryType=" + inventoryType + "&mtCertified=" + mtCertified + "&sortOption=" + sortOption + "&pageNumber=" + inventory.page + "&referralDataEncoded=" + referralDataEncoded;
					inventory.doGet(url)
						.then(function (data) {
	...
	init: function () {
		...
		if (active !== null) {
			...
			ajaxRequestPromises.push(inventory.doGet("/api/inventory/GetVehicles")
				.then(function (data) {
					inventory.data = data;
				})
				.catch(function (error) {
			...
			ajaxRequestPromises.push(inventory.doGet("/api/inventory/GetBodyStyles")
				.then(function (data) {
			...
			// get zipcode (promise)
			ajaxRequestPromises.push(inventory.doGet("/api/inventory/GetZipCode")
				.then(function (data) {
					if (data != null) {
	...
	handlers: {
		...
		submit: function () {
			...
			if (isValid) {
				...
				let path = "/api/inventory/submitlead?make=" + make +
		...
		if (buttons !== null) {
			buttons.forEach(function (element) {
				element.addEventListener("click", function () {
					...
					let path = "/api/inventory/submittyplead?make=" + make + "&model=" + model +
